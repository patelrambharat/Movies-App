...
export default class Movies extends Component {
    ...
    loadMoreMovies = async() => {
        ...
        const res = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=0c4cb3c2be6e1acdec7c42f6cf21f63e&language=en-US&page=${newPage}`);
        let data = res.data
        // console.log(data);
        this.setState({
    ...
    async componentDidMount(){
        //Side effects 
        const res = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=0c4cb3c2be6e1acdec7c42f6cf21f63e&language=en-US&page=${this.state.currPage}`);
        let data = res.data
        // console.log(data);
        this.setState({
            movies:[...data.results]
